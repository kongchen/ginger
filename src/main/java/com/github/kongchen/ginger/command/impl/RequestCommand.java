 ...
 */
public class RequestCommand extends ExecutableCommand {
    public RequestCommand(SequenceContext context, String left, int expCode, List<Argument> arguments) {
        super(context, left, expCode, arguments);
    }

    @Override
    public void execute() throws GingerException {
        handleAssignment(left, args, false, null, expectCode);
    }
}
